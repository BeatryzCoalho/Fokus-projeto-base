...
const paragrafoDescricaoTarefva = document.querySelector('.app__section-active-task-description')
    ...
    if (tarefa.completa){
        ...
        li.onclick =  () => {
            ...
            if (tarefaSelecionada == tarefa){
                paragrafoDescricaoTarefva.textContent = ''
            ...
            paragrafoDescricaoTarefva.textContent = tarefa.descricao
